...
@Mod(
		modid = "tfcpluswatercompatibility",
		name = "TFC+ Water Compatibility",
		version = "1.6", 
...
public class TFCWaterCompatibility {
	...
	private void replaceValueInStaticFinalField(Object itemToReplace, Field field) throws Exception, IllegalAccessException {
